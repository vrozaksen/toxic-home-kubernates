...
OAUTH2_CONFIG = [{
    ...
    "OAUTH2_AUTHORIZATION_URL": "https://sso.${SECRET_DOMAIN}/api/oidc/authorization",
    "OAUTH2_API_BASE_URL": "https://sso.${SECRET_DOMAIN}/",
    "OAUTH2_USERINFO_ENDPOINT": "https://sso.${SECRET_DOMAIN}/api/oidc/userinfo",
    "OAUTH2_SERVER_METADATA_URL": "https://sso.${SECRET_DOMAIN}/.well-known/openid-configuration",
